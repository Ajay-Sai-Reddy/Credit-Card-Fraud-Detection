# -*- coding: utf-8 -*-
"""
Created on Sun Sep 20 13:27:06 2020
...
#Training the kernal Naive bayes Model on the Training set
...
plt.title('Receiver Operating Characteristic - Naive bayes model')
