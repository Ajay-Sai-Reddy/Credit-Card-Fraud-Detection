# -*- coding: utf-8 -*-
"""
Created on Sun Sep 20 13:29:49 2020
...
#Training the kernal DECISION TREE Model on the Training set
...
print('roc_auc_score for DECISION TREE: ', roc_auc_score(y_test, y_pred))
