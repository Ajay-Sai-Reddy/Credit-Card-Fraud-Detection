# -*- coding: utf-8 -*-
"""
Created on Sun Sep 20 13:23:48 2020
...
print('roc_auc_score for kernal SVM model: ', roc_auc_score(y_test, y_pred))
plt.title('Receiver Operating Characteristic - kernal SVM model')
